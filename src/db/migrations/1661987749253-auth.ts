...
export class auth1661987749253 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "active" boolean NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_profiles_profile" ("userId" integer NOT NULL, "profileId" integer NOT NULL, CONSTRAINT "PK_3fd612037483bb43de64c850b0e" PRIMARY KEY ("userId", "profileId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f242c0b590e77b91136f23e40b" ON "user_profiles_profile" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_39cce0bc4925eb8a93ac1420de" ON "user_profiles_profile" ("profileId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_profiles_profile" ADD CONSTRAINT "FK_f242c0b590e77b91136f23e40bd" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_profiles_profile" ADD CONSTRAINT "FK_39cce0bc4925eb8a93ac1420dee" FOREIGN KEY ("profileId") REFERENCES "profile"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_profiles_profile" DROP CONSTRAINT "FK_39cce0bc4925eb8a93ac1420dee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_profiles_profile" DROP CONSTRAINT "FK_f242c0b590e77b91136f23e40bd"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_39cce0bc4925eb8a93ac1420de"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f242c0b590e77b91136f23e40b"`,
    );
